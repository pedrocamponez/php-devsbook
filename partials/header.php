<?php
$firstName = current(explode(' ', $userInfo->name)); //explode no array do nome e com o current pegamos apenas o primeiro nome
//para mostrar no "user-area-text".
?>
<!DOCTYPE html>
<html>
<head>
            ...
            <div class="head-side">
                ...
                <div class="head-side-right">
                    <a href="<?=$base;?>/perfil.php" class="user-area">
                        <div class="user-area-text">Welcome, <?=$firstName;?>!</div>
